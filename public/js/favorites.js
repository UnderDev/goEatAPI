...
angular.module('myApp.favorites', ['ngRoute'])
  ...
  .controller('FavoritesCtrl', ['$scope', '$route', 'PeopleService', 'RemoveServiceFav', 'geolocationSvc', 'DirectionService', '$sce', function ($scope, $route, PeopleService, RemoveServiceFav, geolocationSvc, DirectionService, $sce) {

    $scope.showMap = true; //used to show and hide map details
    var loc; //variable for storing users current location
    $scope.favs = []; //favs holds all the user places retrieved from database
    ...
    if (typeof (Storage) !== "undefined") {
        ...
        //function for removing item from favourite list
